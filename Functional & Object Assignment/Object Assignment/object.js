...
function Q5(){
    ...
    var info = {
     ...
     info.Middlename = "Ajith";
    document.write(`After defining The middle name is : ${info.Middlename}`);
};
 
function Q6(){
var string = "{firstName:'Balaji', age:21, city:'Chennai', state:'TamilNadu', country:'India'}";
eval('var obj='+string);
document.write(obj);
string.MiddleName = "Satheesh";
...
function Q7(){
var obj = '{ "firstName":"Kaveesh", "lastName":"Kumar" }';
obj = JSON.parse(obj); 
document.write(obj);
};